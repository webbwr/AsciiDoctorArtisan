...
4. `macos_optimizer.py` - 156 lines (MEDIUM priority, macOS-specific)
5. `template_browser.py` - 177 lines (LOW priority, complex Qt UI)
6. Plus 17 more files...
