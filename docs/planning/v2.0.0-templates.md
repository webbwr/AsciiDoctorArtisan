...
2. **Usability**
   - Simple 3-step wizard: Select → Configure → Create
...
└──────────────┬──────────────────────────────────┘
      ...
      ▼                 ▼                         ▼
┌──────────────┐ ┌──────────────┐ ┌──────────────────┐
│ Built-in     │ │ Custom       │ │ Template Storage │
│ Templates    │ │ Templates    │ │ - JSON metadata  │
│ (bundled)    │ │ (user)       │ │ - .adoc files    │
└──────────────┘ └──────────────┘ └──────────────────┘
```
...
│   │   ├── template_metadata.py         # Metadata model
│   │   ├── variable_validator.py        # Variable validation
│   │   └── builtin_templates.py         # Built-in template definitions
│   └── models.py                         # Add Template model
├── ui/
│   ├── template_browser_dialog.py       # Template browser UI
│   ├── template_editor_dialog.py        # Template editor UI
│   └── template_variable_form.py        # Variable input form
├── templates/                            # Built-in template files
│   ├── article.adoc
│   ├── book.adoc
│   ├── man_page.adoc
│   ├── technical_report.adoc
│   ├── readme.adoc
│   ├── meeting_notes.adoc
│   ├── tutorial.adoc
│   └── api_documentation.adoc
└── tests/unit/core/templates/
    ├── test_template_engine.py          # Engine tests
    ├── test_template_manager.py         # Manager tests
    ├── test_template_metadata.py        # Metadata tests
    ├── test_variable_validator.py       # Validation tests
    └── test_builtin_templates.py        # Built-in template tests
```
...
```
templates/
├── metadata.json               # Index of all custom templates
├── custom-template-1/
│   ├── template.adoc
...
```
┌────────────────────────────────────────────────────────────┐
│ New Document from Template                           [X]   │
├────────────────────────────────────────────────────────────┤
│ Search: [_______________] Category: [All ▼] [Built-in ▼]  │
├──────────────────────┬─────────────────────────────────────┤
│ ┌─────────┐          │ Article Template                    │
│ │ Article │ ●        │                                     │
│ └─────────┘          │ Standard technical article with:    │
│ ┌─────────┐          │ - Title, author, version            │
│ │  Book   │          │ - Introduction and conclusion       │
│ └─────────┘          │ - Two customizable sections         │
│ ┌─────────┐          │                                     │
│ │ Man Page│          │ Variables (6):                      │
│ └─────────┘          │ • Title (required)                  │
│ ┌─────────┐          │ • Author (required)                 │
...
```
┌────────────────────────────────────────────────────────────┐
│ Configure Template Variables                        [X]   │
├────────────────────────────────────────────────────────────┤
│ Title *                                                    │
│ [My Article Title________________________]                 │
│                                                            │
│ Author *                                                   │
│ [John Doe____________________________]                     │
│                                                            │
│ Email                                                      │
...
- Full workflow: Browse → Select → Configure → Create
