...
**Version:** 2.0.6+ | **For:** Contributors and developers
...
**Feature file** (`tests/e2e/features/document_editing.feature`):
```gherkin
...
**Step definitions** (`tests/e2e/step_defs/document_steps.py`):
```python
