...
class TestGetPreviewWidgetInfo:
    ...
    @patch("asciidoc_artisan.ui.preview_handler_gpu.QWebEngineSettings")
    @patch("asciidoc_artisan.ui.preview_handler_gpu.get_gpu_info")
    def test_widget_info_for_webengine_view(self, mock_get_gpu_info, mock_settings_cls, mock_webengine_cls):
    ...
    @patch("asciidoc_artisan.ui.preview_handler_gpu.QWebEngineSettings")
    @patch("asciidoc_artisan.ui.preview_handler_gpu.get_gpu_info")
    def test_widget_info_webengine_settings_disabled(self, mock_get_gpu_info, mock_settings_cls):
        ...
        mock_widget.page = Mock()
        mock_settings = Mock()
        mock_settings.testAttribute = Mock(side_effect=[False, False])  # 2d canvas and webgl disabled
        mock_widget.settings = Mock(return_value=mock_settings)
