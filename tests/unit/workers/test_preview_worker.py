...
class TestIncrementalRendering:
    ...
    @patch("asciidoc_artisan.workers.preview_worker.AsciiDoc3API")
    def test_large_document_uses_incremental_rendering(self, mock_api_class, mock_incremental_class):
...
class TestMetricsRecording:
    ...
    @patch("asciidoc_artisan.workers.preview_worker.IncrementalPreviewRenderer")
    @patch("asciidoc_artisan.workers.preview_worker.AsciiDoc3API")
    def test_metrics_recorded_on_incremental_render(self, mock_api_class, mock_incremental_class, mock_get_metrics):
