...
MA principle: Reduced from 468→~380 lines by extracting cancelable_runnable.py.
...
from asciidoc_artisan.workers.cancelable_runnable import CancelableRunnable

# Re-export CancelableRunnable for backward compatibility
__all__ = ["CancelableRunnable", "OptimizedWorkerPool", "TaskPriority", "TaskMetadata", "TaskSignals"]
